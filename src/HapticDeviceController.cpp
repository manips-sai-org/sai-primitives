...
namespace SaiPrimitives
{
	...
	void HapticDeviceController::setHapticControlType(
		const HapticControlType &haptic_control_type, const bool reset_offset)
	{
		...
		_device_homed = false;
		_reset_robot_linear_offset = reset_offset;
		_reset_robot_angular_offset = reset_offset;
	...
	void HapticDeviceController::enableOrientationTeleop(const bool reset_offset)
	{
