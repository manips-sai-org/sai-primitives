...
struct Singularity {
    ...
    double sigma;
    double lambda;
    VectorXd dsdq;  // gradient descent will increase singular value
...
private:
    ...
    VectorXd getInitialVector(const std::vector<MatrixXd>& kinematic_hessian,
                                                  const MatrixXd& U,
                                                  const MatrixXd& V); 

    bool checkBasisForType1(const std::vector<MatrixXd>& kinematic_hessian,
                                                               const MatrixXd& U,
                                                               const MatrixXd& V);   
