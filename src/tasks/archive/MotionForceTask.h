...
public:
	...
	void enableZeroCrossingReset(const bool flag) {
		_enable_zero_crossing_reset = flag;
	}
	...
	void enableForceControlTaskDamping(const bool flag) {
		_singularity_handler->enableForceInertiaShaping(flag);
	}
...
private:
	...
	// zero crossing reset
	bool _enable_zero_crossing_reset;
	Vector3d _prev_position_error;
	Vector3d _prev_step_orientation_error;
