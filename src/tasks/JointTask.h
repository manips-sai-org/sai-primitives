...
private:
	...
	struct AutomaticOtgTrackingModeSwitchParams {
		...
		double goal_update_tolerance = 1e-5;
	...
	VectorXd _automatic_otg_tracking_previous_goal_position;
